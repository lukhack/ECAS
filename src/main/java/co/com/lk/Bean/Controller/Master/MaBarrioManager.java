...
@Named
@ApplicationScoped
public class MaBarrioManager extends UiManager<Mabarrio>{
    
    
    public MaBarrioManager() {
        super(new Mabarrio());
        findList();
    }

    @Override
    public List<Mabarrio> getList() {
        return super.getList(); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public void save(Mabarrio obj, List<String> updateObjecView) {
