...
import co.com.lk.Bean.dt.DtMaUnidadMedidaController;
...
@Named
@ViewScoped
@FacesConverter(value = "unidadMedidaConvert")
public class UnidadMedidaConvert implements Converter,Serializable {
    @Inject
    DtMaUnidadMedidaController Obj;
    ...
    public String getAsString(FacesContext fc, UIComponent uic, Object object) {
        try{ 
            if(object != null && !object.equals("")) {
                return String.valueOf(((Dtmaunidadmedida) object).getId());
            }else{
                return null;
            }
        }catch(Exception ex){
