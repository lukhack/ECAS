...
import co.com.lk.Bean.dt.DtMaEstrato;
...
@Named
@ViewScoped
@FacesConverter(value = "estratoConvert")
public class EstratoConvert implements Converter,Serializable {
    @Inject
    DtMaEstrato Obj;
    ...
    public String getAsString(FacesContext fc, UIComponent uic, Object object) {
        try{ 
            if(object != null && !object.equals("")) {
                return String.valueOf(((Dtmaestrato) object).getId());
            }else{
                return null;
            }
        }catch(Exception ex){
