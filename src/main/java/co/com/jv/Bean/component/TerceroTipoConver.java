...
@Named
@ViewScoped
@FacesConverter(value = "terceroTipoConvert")
public class TerceroTipoConver implements Converter,Serializable  {
    @Inject
    UiTerceroTipoManager obj;
    ...
    public String getAsString(FacesContext fc, UIComponent uic, Object object) {
        try{ 
            if(object != null && !object.equals("")) {
                return String.valueOf(((Dttercerotipo) object).getId());
            }else{
                return null;
            }
        }catch(Exception ex){
