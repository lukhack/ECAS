...
import co.com.lk.Bean.dt.DtMaEstadoCivil;
...
@Named
@ViewScoped
@FacesConverter(value = "estadoCivilConvert")
public class EstadoCivilConvert implements Converter,Serializable {
    @Inject
    DtMaEstadoCivil Obj;
    ...
    public String getAsString(FacesContext fc, UIComponent uic, Object object) {
        try{ 
            if(object != null && !object.equals("")) {
                return String.valueOf(((Dtmaestadocivil) object).getId());
            }else{
                return null;
            }
        }catch(Exception ex){
