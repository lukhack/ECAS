...
import co.com.lk.Bean.dt.DtTerceroNaturalController;
...
@Named
@ViewScoped
@FacesConverter(value = "terceroNaturalConvert")
public class TerceroNaturalConver implements Converter,Serializable  {
    @Inject
    DtTerceroNaturalController obj;
    ...
    public String getAsString(FacesContext fc, UIComponent uic, Object object) {
        try{ 
            if(object != null && !object.equals("")) {
                return String.valueOf(((Dtterceronatural) object).getId());
            }else{
                return null;
            }
        }catch(Exception ex){
